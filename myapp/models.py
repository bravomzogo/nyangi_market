...
class Tech(models.Model):
    ...
    storage_capacity = models.CharField(max_length=100,blank=True)
    screen_size = models.CharField(max_length=50,blank=True)
    resolution = models.CharField(max_length=100,blank=True)

    # Furniture & Home Decor
    weight_capacity = models.CharField(max_length=50,blank=True)
    ...
    upholstery_material = models.CharField(max_length=100,blank=True)
    ...
    dietary_info = models.CharField(max_length=100,blank=True)
    ...
    safety_certifications = models.CharField(max_length=100,blank=True)
    battery_required = models.BooleanField(blank=True, null=True)
    interactive_features = models.CharField(max_length=100,blank=True)
    ...
    material_durability = models.CharField(max_length=100,blank=True)
